...
[![npm](https://img.shields.io/npm/v/@dramaorg/laborum-sit.svg?maxAge=3600)](https://www.npmjs.com/package/@dramaorg/laborum-sit)
[![JavaScript Style Guide](https://img.shields.io/badge/code%20style-standard-brightgreen.svg?maxAge=3600)](http://standardjs.com/)
[![Greenkeeper badge](https://badges.greenkeeper.io/lukastaegert/@dramaorg/laborum-sit.svg)](https://greenkeeper.io/)
...
Next, install `@dramaorg/laborum-sit`:

```
$ npm install @dramaorg/laborum-sit --save-dev
```

**Note:** If you installed ESLint globally (using the `-g` flag) then you must also install `@dramaorg/laborum-sit` globally.
